(function () {
  ...
  const onChange = async (event) => {
      ...
      const res2 = await (storage === null || storage === void 0 ? void 0 : storage.store({
      ...
      console.log('res: ', res);
      storage === null || storage === void 0 ? void 0 : storage.iterate((key) => {
          console.log('Key: ', key);
      });
      const count = await (storage === null || storage === void 0 ? void 0 : storage.count());
      console.log('count: ', count);
      await (storage === null || storage === void 0 ? void 0 : storage.delete(DocumentCategory.W2));
      const countAfterDelete = await (storage === null || storage === void 0 ? void 0 : storage.count());
